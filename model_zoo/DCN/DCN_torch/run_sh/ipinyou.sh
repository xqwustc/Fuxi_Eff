...
do
    ...
    python /data/STEVEN8868/FuxiCTR/model_zoo/DCN/DCN_torch/run_expid_prefeat.py --expid DCN_feat_retrain_ipinyou --gpu 0 --keep_ratio ${xx} >> "DCN_feat_retrain_ipinyoux2_${timestamp}.log" 2>&1
