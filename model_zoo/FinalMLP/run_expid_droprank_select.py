...
if __name__ == '__main__':
    ...
    # email.common_send('DCN_droprank_select.py - Ava - Build Data',"")
    ...
    logging.info('Training time: {} with {} items'.format(total_time_ms,
                                                          params['batch_size'] * len(train_gen)))
    # email.common_send('DCN_droprank_select.py - Ava - Training', "")
    ...
    print('Training Time: {} ms'.format(total_time_ms))
    logging.info('Valid result: {}'.format(valid_result))
